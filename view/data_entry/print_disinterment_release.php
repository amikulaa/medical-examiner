...
$pdf = new FPDF();
$pdf->SetTitle('Disinterment Release PDF');
$pdf->AliasNbPages();
...
foreach($results as $row){
    ...
    $pdf->Cell(0, 5, 'Current Decedent Interment Information', 1, 1, 'C');
        ...
        $pdf->SetFont($font,'', $font3);
        $pdf->Cell(20, 5, $row->first_mi_name, 'B', 0, 'L');
        $pdf->Cell(5, 5, '     ', 0, 0);
        $pdf->Cell(20, 5, $row->last_name, 'B', 0, 'L');
        ...
        $pdf->SetFont($font,'', $font3);
        $pdf->Cell(30, 5, $row->age_infant, 'B', 0, 'L');
        ...
        $pdf->SetFont($font,'', $font3);
        $pdf->Cell(30, 5, $row->current_cemetery_lot, 'B', 0, 'L');
        ...
        $pdf->SetFont($font,'', $font3);
        $pdf->Cell(50, 5, $row->current_cemetery_name, 'B', 0, 'L');
        ...
        $pdf->SetFont($font,'', $font3);
        $pdf->Cell(70, 5, $row->current_cemetery_citystatezip, 'B', 0, 'L');
        ...
        $pdf->SetFont($font,'', $font3);
        $pdf->Cell(40, 5, $row->current_cemetery_country, 'B', 0, 'L');
        $pdf->SetFont($font,'B', $font3);
    ...
    $pdf->Ln(5);
        ...
        $pdf->Cell(20, 5, '', 0, 0);
        $pdf->Cell(5, 5, $row->new_dispo == true ? 4 : "", 1, 0);
        $pdf->SetFont($font,'B', $font3);
        ...
        $pdf->Cell(5, 5, '', 0, 0);
        $pdf->SetFont('ZapfDingbats','', 10);
        $pdf->Cell(5, 5, $row->new_cremated == true ? 4 : "", 1, 0);
        $pdf->SetFont($font,'B', $font3);
        ...
        $pdf->Cell(0, 8, '', 0, 1, '');
            ...
            $pdf->Cell(25, 5, '                 ', 0, 0);
            $pdf->SetFont('ZapfDingbats','', 10);
            $pdf->Cell(5, 5, $row->new_cremated_interred == true ? 4 : "", 1, 0);
            $pdf->SetFont($font,'B', $font3);
            ...
            $pdf->Cell(25, 5, '                 ', 0, 0);
            $pdf->SetFont('ZapfDingbats','', 10);
            $pdf->Cell(5, 5, $row->new_cremated_mausoleum == true ? 4 : "", 1, 0);
            $pdf->SetFont($font,'B', $font3);
            ...
            $pdf->Cell(25, 5, '                 ', 0, 0);
            $pdf->SetFont('ZapfDingbats','', 10);
            $pdf->Cell(5, 5, $row->new_cremated_delegated == true ? 4 : "", 1, 0);
            $pdf->SetFont($font,'B', $font3);
        ...
        $pdf->Cell(5, 5, '     ', 0, 0);
        $pdf->SetFont('ZapfDingbats','', 10);
        $pdf->Cell(5, 5, $row->new_reinterred == true ? 4 : "", 1, 0);
        $pdf->SetFont($font,'B', $font3);
        ...
        $pdf->SetFont($font,'', $font3);
        $pdf->Cell(40, 5, $row->new_cemetery_lot, 'B', 0, 'L');
        ...
        $pdf->SetFont($font,'', $font3);
        $pdf->Cell(80, 5, $row->new_cemetery_name, 'B', 0, 'L');
        ...
        $pdf->SetFont($font,'', $font3);
        $pdf->Cell(30, 5, $row->new_cemetery_citystatezip, 'B', 0, 'L');
        ...
        $pdf->SetFont($font,'', $font3);
        $pdf->Cell(30, 5, $row->new_cemetery_county, 'B', 0, 'L');
        ...
        $pdf->SetFont($font,'', $font3);
        $pdf->Cell(20, 5, $row->new_cemetery_state_country, 'B', 0, 'L');
    ...
    $pdf->Ln(5);
        ...
        $pdf->SetFont($font,'', $font3);
        $pdf->Cell(20, 5, $row->applicant_name, 'B', 0, 'L');
        ...
        $pdf->SetFont($font,'', $font3);
        $pdf->Cell(20, 5, $row->applicant_license, 'B', 0, 'L');
        ...
        $pdf->SetFont($font,'', $font3);
        $pdf->Cell(80, 5, $row->applicant_fulladdress, 'B', 0, 'L');
        ...
        $pdf->SetFont($font,'', $font3);
        $pdf->Cell(25, 5, $row->applicant_phone, 'B', 0, 'L');
        ...
        $pdf->SetFont('ZapfDingbats','', 10);
        $pdf->Cell(5, 5, $row->applicant_payment == true ? 4 : "", 1, 0);
        ...
        $pdf->SetFont('ZapfDingbats','', 10);
        $pdf->Cell(5, 5, $row->applicant_nnok == true ? 4 : "", 1, 0);
        $pdf->SetFont($font,'B', $font3);
        $pdf->Cell(55, 5, 'Notarized Next of Kin Request', 0, 0, 'L');
        $pdf->SetFont('ZapfDingbats','', 10);
        $pdf->Cell(5, 5, $row->applicant_agreement == true ? 4 : "", 1, 0);
        $pdf->SetFont($font,'B', $font3);
    ...
    $pdf->Ln(5);
        ...
        $pdf->SetFont($font,'', $font3);
        $pdf->Cell(50, 5, $row->issuing_official_name, 'B', 0, 'L');
        ...
        $pdf->SetFont($font,'', $font3);
        $pdf->Cell(15, 5, $row->issuing_official_title, 'B', 0, 'L');
        ...
        $pdf->Cell(5, 5, '     ', 0, 0);
        $pdf->SetFont($font,'', $font3);
        $pdf->Cell(20, 5, $row->issuing_official_signature_date, 'B', 0, 'L');
        $pdf->SetFont($font,'B', $font3);
