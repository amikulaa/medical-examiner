...
$pdf = new FPDF();
$pdf->SetTitle('Embalm Permit PDF');
$pdf->AliasNbPages();
...
foreach($results as $row){
    ...
    $pdf->SetFont($font,'', $font3);
    $pdf->Cell(70, 5, $row->first_mi_name, 'B', 0, 'L');
    $pdf->Cell(75, 5, $row->last_name, 'B', 2, 'L');
    ...
    $pdf->SetFont($font,'', $font3);
    $pdf->Cell(145, 5, $row->full_address, 'B', 0, 'L');
    ...
    $pdf->SetFont($font,'', $font3);
    $pdf->Cell(70, 5, $row->pronounced_citystatezip, 'B', 0, 'L');
    $pdf->Cell(70, 5, $row->pronounced_county, 'B', 2, 'L');
    $pdf->SetFont($font,'I', $font4);
    $pdf->SetX(45);
    ...
    $pdf->SetFont($font,'', $font3);
    $pdf->Cell(140, 5, $row->pronounced_physician, 'B', 0, 'L');
    ...
    $pdf->SetFont($font,'', $font3);
    $pdf->Cell(20, 5, $row->date_of_death, 'B', 0, 'L');
    $pdf->Cell(5, 7, '     ', 0, 0);
    $pdf->SetFont($font,'B', $font3);
    $pdf->Cell(30, 5, 'Time Pronounced: ', 0, 0, 'L');
    $pdf->SetFont($font,'', $font3);
    $pdf->Cell(20, 5, $row->time_of_death, 'B', 0, 'L');
    ...
    $pdf->SetFont($font,'', $font3);
    $pdf->Cell(115, 5, $row->sign_dc_physician, 'B', 0, 'L');
    ...
    $pdf->SetFont($font,'', $font3);
    $pdf->Cell(30, 5, $row->embalm_date, 'B', 0, 'L');
    $pdf->Cell(20, 7, '', 0, 0);
    ...
    $pdf->SetFont($font,'', $font3);
    $pdf->Cell(70, 5, $row->embalm_recieved_by, 'B', 2, 'L');
    $pdf->SetFont($font,'I', $font4);
